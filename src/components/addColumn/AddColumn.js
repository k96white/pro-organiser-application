        ...
        <>
            ...
            {showModal &&
             <Modal flag={'addColumn'}>
                        <button type="button" className="close" data-dismiss="modal" style={{width:'5%'}} onClick={()=>setShowModal(false)}>&times;</button>
                        <h5 className={modalStyles.modalTitle}>Add column</h5><br/>
                        <div className={modalStyles.addColumnInput}>
                            <label htmlFor='column_name'>Enter a column name:</label>
                            <input id='column_name' type='text' value={columnName} className={modalStyles.inputBox} onChange={(e)=>{e.preventDefault();setColumnName(e.target.value);}}></input><br/><br/>
                                                      
                        </div>
                        <br/>
                        <button className='btn btn-primary' id='CreateColumn' onClick={handleAddColumnClick}>Add Column</button><br/><br/>
